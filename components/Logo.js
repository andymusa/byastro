...
export default function Logo({ className = "", textClass = "text-3xl" }) {
  return (
    <Link href="/" className={`flex items-center gap-1.5 text-brown-600 ${className}`}>
      <span className={`font-hand font-extrabold lowercase tracking-tight ${textClass}`}>
        byastro
      </span>
